...
//    (the bulid process should yield a AmbiCorder.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:AmbiCorder.chug AmbiCorder-test.ck`
//
...
//    `chuck --chugin:AmbiCorder.chug AmbiCorder-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a AmbiCorder
AmbiCorder obj;
