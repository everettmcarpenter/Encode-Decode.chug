...
vers.addFile("../current-builds/mac/Encode.chug");
vers.addFile("../current-builds/mac/Decode.chug");
vers.addFile("../current-builds/mac/SADN.chug");
vers.addFile("../current-builds/mac/OrderGain.chug");
vers.addFile("../current-builds/mac/Mirror.chug");
vers.addFile("../current-builds/mac/ABFormat.chug");
vers.addFile("../current-builds/mac/BAFormat.chug");
