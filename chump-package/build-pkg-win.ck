...
vers.addFile("../current-builds/win/Encode.chug");
vers.addFile("../current-builds/win/Decode.chug");
vers.addFile("../current-builds/win/SADN.chug");
vers.addFile("../current-builds/win/OrderGain.chug");
vers.addFile("../current-builds/win/Mirror.chug");
